...
To update the database use this command from the Web project folder (replace `ShifaEMR` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../ShifaEMR.Infrastructure/ShifaEMR.Infrastructure.csproj -s ShifaEMR.Web.csproj
```
